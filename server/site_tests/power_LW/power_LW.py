...
class power_LW(test.test):
    ...
    def run_once(self,
        ...
        @param tast_server_test: if the wrapped test is a tast server test. Ifs
        ...
        """
        # Logs out of ChromeOS before connecting to wlan to prevent the wifi
        # configuration from being saved to the user's profile instead of the device's profile.
        g2f_utils.ChromeOSLogout(host)
