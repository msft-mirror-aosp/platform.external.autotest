...
MSC_SCAN_BTN_EVENT = {
        ...
        'GAMEPAD_LEFT_STICK': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_THUMBL),
        'GAMEPAD_RIGHT_STICK': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_THUMBR),
        'GAMEPAD_BUTTON_LEFT_BUMPER': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_TL),
        'GAMEPAD_BUTTON_RIGHT_BUMPER': Event(EV_MSC, MSC_SCAN,
                                             MSC_SCAN_BTN_TR),
}
