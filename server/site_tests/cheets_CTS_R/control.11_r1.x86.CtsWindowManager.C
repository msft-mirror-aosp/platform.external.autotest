...
AUTHOR = 'ARC++ Team'
NAME = 'cheets_CTS_R.11_r1.x86.CtsWindowManager.C'
...
def run_TS(machine):
    ...
    job.run_test(
        ...
        hosts=host_list,
        iterations=1,
        tag='11_r1.x86.CtsWindowManager.C',
        test_name='cheets_CTS_R.11_r1.x86.CtsWindowManager.C',
        ...
        target_plan=None,
        bundle='x86',
        uri='gs://chromeos-arc-images/cts/bundle/R/android-cts-6823915-linux_x86-x86.zip',
        use_jdk9=True,
        timeout=3600)
