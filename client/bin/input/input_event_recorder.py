...
MSC_SCAN_BTN_A = 90001
MSC_SCAN_BTN_B = 90002
MSC_SCAN_BTN_X = 90004
MSC_SCAN_BTN_Y = 90005
MSC_SCAN_BTN_TL = 90007
MSC_SCAN_BTN_TR = 90008
MSC_SCAN_BTN_START = 9000
MSC_SCAN_BTN_THUMBL = 9000
MSC_SCAN_BTN_THUMBR = 9000
...
MSC_SCAN_BTN_EVENT = {
    'LEFT': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_LEFT),
    'RIGHT': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_RIGHT),
    'MIDDLE': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_MIDDLE),
    'GAMEPAD_BUTTON_A': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_A),
    'GAMEPAD_BUTTON_B': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_B),
    'GAMEPAD_BUTTON_X': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_X),
    'GAMEPAD_BUTTON_Y': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_Y),
    'GAMEPAD_BUTTON_START': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_START),
    'GAMEPAD_LEFT_THUMBSTICK': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_THUMBL),
    'GAMEPAD_RIGHT_THUMBSTICK': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_THUMBR),
    'GAMEPAD_BUTTON_LEFT_BUMPER': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_TL),
    'GAMEPAD_BUTTON_RIGHT_BUMPER': Event(EV_MSC, MSC_SCAN, MSC_SCAN_BTN_TR),
}
