...
class TradefedTestTest(unittest.TestCase):
    ...
    # Verify that parsing gsutil hash correctly extracts md5 hash and returns
    # in hex.
    def test_parse_md5_hash(self):
        md5_hex = tradefed_test._GetMd5HashFromGsutilOutput(
        ...
        self.assertEqual(md5_hex, '91cdeeaf0cefc766692eb3c5a53d5913')
    ...
    def test_download_to_cache_initial_download(self, mock_exists, mock_run,
        ...
        mock_run.return_value = Mock(
                stdout='Hash (md5):91cdeeaf0cefc766692eb3c5a53d5913')
        ...
        mock_download_to_dir.assert_called_with(
                ...
                os.path.join(self.tradefed._tradefed_cache,
                             '91cdeeaf0cefc766692eb3c5a53d5913'))
    ...
    def test_download_to_cache_same_google_storage_path_different_bundle(
        ...
        mock_run.return_value = Mock(
                stdout='Hash (md5):457d8d5d1c3137e19b1ac89ac120c4e7')
        self.tradefed._download_to_cache(
                'gs://some-fake-bucket/path/to/bundle.zip')
        ...
        mock_exists.assert_called_with(
                os.path.join(self.tradefed._tradefed_cache,
                             '457d8d5d1c3137e19b1ac89ac120c4e7'))
    ...
    # Verify that an exception is raised if there isn't an md5 hash in the input text.
    def test_failed_to_find_md5_hash(self):
        self.assertRaises(tradefed_test.Md5HashNotFoundException,
                          tradefed_test._GetMd5HashFromGsutilOutput,
                          'No hash in this message.')

    # Verify that if the parsed hash is not a valid hex of an MD5 hash, then
    # raise an exception.
