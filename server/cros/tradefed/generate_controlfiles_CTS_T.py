...
CONFIG['SPLIT_SUITES'] = {
        ...
        # P98 runtime from PASS/WARN runs between 20251201-20260228, minus fixed
        # approximate overhead of 300 secs with lower bound of 300 secs.
        # https://plx.corp.google.com/scripts2/script_27._73ae8c_21a5_436b_8072_9ebcadd0b57f
        'RUNTIME_HINT_SECS': {
                'CtsAbiOverrideHost': 424,
                'CtsAcceleration': 342,
                'CtsAccessibility': 2040,
                'CtsAccountManager': 543,
                'CtsAccountsHost': 300,
                'CtsActivity': 464,
                'CtsAdServicesDevice': 413,
                'CtsAdb': 300,
                'CtsAdmin': 300,
                'CtsAlarmManager': 838,
                'CtsAmbientContextService': 300,
                'CtsAndroid': 1260,
                'CtsAngleIntegrationHost': 477,
                'CtsAnimation': 730,
                'CtsApacheHttp': 677,
                'CtsApex': 314,
                'CtsApp': 16319,
                ...
                'CtsAutoFillService': 9000,
                'CtsBackgroundRestrictions': 361,
                'CtsBackup': 1399,
                'CtsBatterySaving': 447,
                'CtsBiometrics': 425,
                'CtsBionic': 608,
                'CtsBlobStore': 727,
                'CtsBluetooth': 3146,
                'CtsBoot': 485,
                'CtsBugreportTestCases': 534,
                ...
                'CtsCameraTestCases': 8995,
                'CtsCar': 436,
                'CtsCarrierApi': 426,
                'CtsClassLoaderFactory': 398,
                'CtsClassloaderSplitsHost': 339,
                'CtsClasspathDeviceInfo': 300,
                'CtsClasspaths': 300,
                'CtsColorMode': 300,
                'CtsCompanionDeviceManager': 420,
                'CtsContactsProvider': 571,
                'CtsContent': 2775,
                'CtsControlsDevice': 320,
                'CtsCppTools': 300,
                'CtsCurrentApiSignature': 300,
                'CtsDatabase': 633,
                'CtsDeqp': 9705,
                'CtsDeqpTestCases.isolated-flaky-tests': 582,
                'CtsDevice': 1179,
                'CtsDexMetadataHost': 396,
                'CtsDisplay': 627,
                'CtsDomainVerification': 450,
                'CtsDownloadManager': 356,
                'CtsDpi': 361,
                'CtsDreams': 300,
                'CtsDrm': 300,
                'CtsDropBoxManagerTestCases': 766,
                'CtsDumpsysHost': 300,
                'CtsDynamic': 5758,
                'CtsEdiHost': 550,
                'CtsEffect': 300,
                'CtsExternalService': 300,
                'CtsExtractNativeLibsHost': 300,
                'CtsFileSystem': 7135,
                'CtsFragment': 718,
                'CtsFrameRateOverride': 471,
                'CtsFsMgr': 411,
                'CtsGame': 308,
                'CtsGesture': 300,
                'CtsGpu': 644,
                ...
                'CtsIke': 300,
                'CtsIncidentHost': 974,
                'CtsIncrementalInstallHost': 477,
                'CtsInit': 300,
                'CtsInlineMocking': 1427,
                'CtsInput': 3989,
                'CtsInstallHostTestCases': 1574,
                'CtsInstalledLoadingProgressHost': 543,
                'CtsInstantApp': 300,
                'CtsIntentSignature': 300,
                'CtsJdwp': 2824,
                'CtsJni': 300,
                'CtsJobScheduler': 3461,
                'CtsJvmti': 4508,
                'CtsKernelConfigTestCases': 300,
                'CtsKeystore': 99999,  # b/469911973
                'CtsLeanbackJank': 300,
                'CtsLegacyNotification': 482,
                'CtsLibcore': 36003,
                'CtsLiblog': 350,
                'CtsLibnativehelper': 300,
                'CtsLocale': 485,
                'CtsLocation': 1020,
                'CtsLogd': 300,
                'CtsMatchFlag': 300,
                'CtsMediaAudioTestCases': 3355,
                'CtsMediaAudioTestCases.ctshardware': 2445,
                'CtsMediaBitstreamsTestCases': 1182,
                'CtsMediaCodecTestCases': 2796,
                'CtsMediaCodecTestCases.ctshardware': 1930,
                'CtsMediaDecoderTestCases': 99999,  # b/469911973
                'CtsMediaDecoderTestCases.ctshardware': 6639,
                'CtsMediaDrmFrameworkTestCases': 928,
                'CtsMediaDrmFrameworkTestCases.ctshardware': 1074,
                'CtsMediaEncoderTestCases': 4521,
                'CtsMediaEncoderTestCases.ctshardware': 4838,
                'CtsMediaExtractorTestCases': 451,
                'CtsMediaExtractorTestCases.ctshardware': 300,
                'CtsMediaHostTestCases': 1060,
                'CtsMediaMiscTestCases': 1710,
                'CtsMediaMiscTestCases.ctshardware': 1918,
                'CtsMediaMuxerTestCases': 300,
                'CtsMediaMuxerTestCases.ctshardware': 300,
                'CtsMediaParserHostTestCases': 352,
                'CtsMediaParserTestCases': 375,
                'CtsMediaPerformanceClassTestCases': 484,
                'CtsMediaPlayerTestCases': 7256,
                'CtsMediaPlayerTestCases.ctshardware': 6862,
                'CtsMediaProviderTranscodeTests': 482,
                'CtsMediaRecorderTestCases': 817,
                'CtsMediaRecorderTestCases.ctshardware': 891,
                'CtsMediaStressTestCases': 14600,
                'CtsMediaTranscodingTestCases': 359,
                'CtsMediaV2TestCases': 99999,  # b/469911973
                'CtsMidiTestCases': 884,
                'CtsMimeMap': 300,
                'CtsMocking': 505,
                'CtsMultiUser': 300,
                'CtsMusicRecognition': 386,
                'CtsNNAPI': 859,
                'CtsNNAPIBenchmark': 309,
                'CtsNNAPIJava': 316,
                'CtsNNAPIStatsdAtomHost': 300,
                'CtsNative': 1799,
                'CtsNativeMediaAAudioTestCases.ctshardware': 588,
                'CtsNdef': 300,
                'CtsNdkBinder': 386,
                'CtsNearbyFastPair': 300,
                'CtsNet': 2485,
                'CtsNetTestCases.ctshardware': 4155,
                'CtsNfc': 300,
                'CtsNoPermission': 422,
                ...
                'CtsProto': 370,
                'CtsProvider': 792,
                'CtsQuickAccessWallet': 685,
                'CtsRebootReadiness': 300,
                'CtsRenderscript': 611,
                'CtsResolverService': 402,
                'CtsResourcesLoader': 300,
                'CtsRole': 537,
                'CtsRollbackManagerHostTestCases': 300,
                'CtsRotationResolverServiceDevice': 457,
                'CtsRs': 478,
                'CtsSafetyCenter': 300,
                'CtsSample': 439,
                'CtsSax': 300,
                'CtsScopedStorage': 1369,
                ...
                'CtsSelinux': 565,
                'CtsSensor': 5352,
                'CtsSensorTestCases.ctshardware': 2698,
                ...
                'CtsSilentUpdateHost': 331,
                'CtsSim': 300,
                'CtsSimpleCpu': 377,
                'CtsSimpleperf': 1331,
                'CtsSkQP': 300,
                'CtsSlice': 300,
                'CtsSmartspaceService': 302,
                'CtsSoundTrigger': 300,
                'CtsSpeech': 300,
                'CtsStagedInstallHostTestCases': 683,
                'CtsStatsd': 8015,
                ...
                'CtsVideo': 3086,
                'CtsView': 2919,
                'CtsViewTestCases.ctshardware': 3336,
                ...
                'CtsWidget': 18303,
                'CtsWifi': 4906,
                'CtsWifiTestCases.ctshardware': 4012,
                'CtsWindowManager': 7759,
                'CtsWrap': 346,
                'MicrodroidHost': 300,
                ...
                'art_standalone_dex2oat_cts_tests': 938,
                'art_standalone_libartpalette_tests': 1565,
