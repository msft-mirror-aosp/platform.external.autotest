    ...
    _FIRMWARE_VERSION_MAP = {
            _FP_BOARD_NAME_BLOONCHIPPER: {
                    'bloonchipper_v2.0.4277-9f652bb3-RO_v2.0.24900-aa15589-RW.bin':
                    {
                            ...
                            '9973b944e2a7aa0cb53cd71b90e77e6fb5536b5f91e5ca5241a7d1e5551e7027',
                            _FIRMWARE_VERSION_RO_VERSION:
                            'bloonchipper_v2.0.4277-9f652bb3',
                            _FIRMWARE_VERSION_RW_VERSION:
                            'bloonchipper_v2.0.24900-aa15589',
                    ...
                    {
                            _FIRMWARE_VERSION_SHA256SUM:
                            'bb804ce91480cf022649b3c548596333366e669e37ea09178d00993198cfd482',
                            _FIRMWARE_VERSION_RO_VERSION:
            ...
            _FP_BOARD_NAME_NOCTURNE: {
                    ...
                    {
                            _FIRMWARE_VERSION_SHA256SUM:
                            '2d7263e80e3efef19c2792e735db3df781ea43cd10c12b0a32f7c1f550959c11',
                            _FIRMWARE_VERSION_RO_VERSION:
                            'nocturne_fp_v2.2.64-58cf5974e',
                            _FIRMWARE_VERSION_RW_VERSION:
                            'nocturne_fp_v2.0.24905-73bc70b5',
                            _FIRMWARE_VERSION_KEY_ID:
            ...
            _FP_BOARD_NAME_NAMI: {
                    ...
                    {
                            _FIRMWARE_VERSION_SHA256SUM:
                            '8792b0cdeaa888e1fbe66f6b0758054925fd31060dfdc6241c8bcecb1a585d36',
                            _FIRMWARE_VERSION_RO_VERSION:
                            'nami_fp_v2.2.144-7a08e07eb',
                            _FIRMWARE_VERSION_RW_VERSION:
                            'nami_fp_v2.0.24905-73bc70b511',
                            _FIRMWARE_VERSION_KEY_ID:
            ...
            _FP_BOARD_NAME_DARTMONKEY: {
                    ...
                    {
                            _FIRMWARE_VERSION_SHA256SUM:
                            '2b386815737d4ae90509a16f983ea2045b967102fa393e32b9c65ff6d004ae35',
                            _FIRMWARE_VERSION_RO_VERSION:
                            'dartmonkey_v2.0.2887-311310808',
                            _FIRMWARE_VERSION_RW_VERSION:
                            'dartmonkey_v2.0.24905-73bc70b51',
                            _FIRMWARE_VERSION_KEY_ID:
            ...
            _FP_BOARD_NAME_HELIPILOT: {
                    ...
                    {
                            _FIRMWARE_VERSION_SHA256SUM:
                            '892d9a196027ed15f2bdd5c2b77bfdd8ae70a6abbe4681ed6cc1a4518fa44704',
                            _FIRMWARE_VERSION_RO_VERSION:
                            'helipilot_v2.0.24337-2726e9f149',
                            _FIRMWARE_VERSION_RW_VERSION:
                            'helipilot_v2.0.24901-b1c5caa35e',
                            _FIRMWARE_VERSION_KEY_ID:
