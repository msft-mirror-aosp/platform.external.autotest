...
CROS_REPAIR_ACTIONS = (
        ...
        (cros_repair.LabelCleanupRepair, 'label_cleanup', (),
         ('cros_version_label', )),
        ...
        (cros_repair.ProvisionRepair, 'provision',
         ('ssh', 'writable', 'stop_start_ui', 'tpm', 'good_provision',
          'ext4'), ('power', 'rwfw', 'python', 'cros', 'dev_default_boot')),
...
JETSTREAM_REPAIR_ACTIONS = (
        ...
        (cros_repair.JetstreamTpmRepair, 'jetstream_tpm_repair',
         ('ssh', 'writable', 'tpm', 'good_provision',
          'ext4'), ('power', 'rwfw', 'python', 'cros', 'dev_default_boot',
