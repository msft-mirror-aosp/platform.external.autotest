...
AUTHOR = 'ARC++ Team'
NAME = 'cheets_CTS_R.11_r1.arm.CtsWindowManager.R'
...
def run_TS(machine):
    ...
    job.run_test(
        ...
        hosts=host_list,
        iterations=1,
        tag='11_r1.arm.CtsWindowManager.R',
        test_name='cheets_CTS_R.11_r1.arm.CtsWindowManager.R',
        ...
        target_plan=None,
        bundle='arm',
        uri='gs://chromeos-arc-images/cts/bundle/R/android-cts-6823915-linux_x86-arm.zip',
        use_jdk9=True,
        timeout=3600)
