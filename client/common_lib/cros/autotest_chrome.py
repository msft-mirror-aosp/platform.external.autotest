...
from autotest_lib.client.common_lib.cros.autotestChrome.core import cros_interface, exceptions
from autotest_lib.client.common_lib.cros.autotestChrome.internal.browser import browser_finder
from autotest_lib.client.common_lib.cros.autotestChrome.internal.browser import browser_options
...
class Chrome(object):
    """Wrapper for creating a autotestChrome browser instance with extensions.
    ...
    def __init__(self, logged_in=True, extension_paths=None, autotest_ext=False,
                 ...
                 login_delay=0):
        """
        Constructor of autotestChrome wrapper.
    ...
    @property
    def browser(self):
        """Returns a autotestChrome browser instance."""
        return self._browser

    def get_extension(self, extension_path, retry=5):
        """Fetches a autotestChrome extension instance given the extension path."""
        def _has_ext(ext):
            """
